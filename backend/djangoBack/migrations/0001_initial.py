# Generated by Django 3.2.12 on 2024-02-05 19:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='djangoBack.player')),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='djangoBack.tournament')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='participants',
            field=models.ManyToManyField(blank=True, related_name='tournaments', through='djangoBack.TournamentParticipation', to='djangoBack.Player'),
        ),
        migrations.CreateModel(
            name='PongGame',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round', models.CharField(choices=[('semifinal', 'Semifinal'), ('final', 'Final')], default='NONE', max_length=50)),
                ('date_time', models.DateTimeField(null=True)),
                ('score_player_one', models.IntegerField(default=0)),
                ('score_player_two', models.IntegerField(default=0)),
                ('player_one', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='matches_as_player_one', to='djangoBack.player')),
                ('player_two', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='matches_as_player_two', to='djangoBack.player')),
